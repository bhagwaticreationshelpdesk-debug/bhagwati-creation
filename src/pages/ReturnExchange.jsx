...
const ReturnExchange = () => {
    return (
        <div className="container mx-auto px-4 py-16 max-w-4xl">
            <h1 className="text-4xl font-serif text-[var(--accent-gold)] mb-8 text-center uppercase tracking-widest">Return & Exchange</h1>

            <div className="space-y-8 text-gray-700 leading-relaxed">
                <section>
                    <h2 className="text-lg font-bold text-[var(--accent-gold)] mb-4 uppercase tracking-widest">7-Day Easy Returns</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg font-bold text-[var(--accent-gold)] mb-4 uppercase tracking-widest">Conditions for Return</h2>
                ...
                <section>
                    <h2 className="text-lg font-bold text-[var(--accent-gold)] mb-4 uppercase tracking-widest">How to Initiate a Return</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg font-bold text-[var(--accent-gold)] mb-4 uppercase tracking-widest">Refund Process</h2>
                    <p>
