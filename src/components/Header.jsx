...
const Header = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            // Always show header when at the top or in the hero section
    ...
    return (
        <>
            ...
            <div className="h-24 md:h-28 w-full bg-transparent" />

            <div className={`fixed top-0 left-0 w-full z-50 py-4 px-4 transition-transform duration-500 ease-in-out ${isVisible ? 'translate-y-0' : '-translate-y-[150%]'}`}>
