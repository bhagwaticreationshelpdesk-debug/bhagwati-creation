                    ...
                    <div className="w-full flex flex-col items-center max-w-sm">
                        ...
                        <div className="w-full space-y-6">
                            ...
                            <button
                                ...
                                className={`w-full py-4 text-sm font-bold tracking-[0.2em] uppercase transition-all duration-300 shadow-xl ${phoneNumber.length === 10
                            ...
                            >
                                {/* Simple Google G Icon via SVG directly ensures no dependency issues */}
